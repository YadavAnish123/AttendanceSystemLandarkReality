          ...
          <div className="md:w-2/3 md:pl-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              ...
              {showMore && (
                <>
                  <br />
                  I am always eager to learn new things and improve my skills. In my free time, I contribute to open-source projects and stay active in the tech community.
                  I believe in writing clean, maintainable code and collaborating with others to build meaningful software.
                </>
              )}
            </p>
            <button
              onClick={() => setShowMore(!showMore)}
              className="text-indigo-800 dark:text-blue-900 hover:underline"
            >
              {showMore ? 'See Less' : 'See More'}
            </button>

            {/* Skills */}
            <h2 className="text-xl font-semibold text-indigo-800 dark:text-white mb-4 mt-6">Skills</h2>
